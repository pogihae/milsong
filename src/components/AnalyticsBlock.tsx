  ...
  return (
    <section className="glass-panel relative rounded-[2rem] p-6 sm:p-8">
      <h2 className="mb-5 flex items-center gap-3 text-xl font-bold text-slate-900">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-pink-100 text-pink-600 shadow-inner">
      ...
      <ul className="space-y-4 text-slate-700">
        {analytics.map((line, i) => (
          <li key={i} className="flex gap-4">
            <div className="mt-1.5 flex h-2 w-2 shrink-0 rounded-full bg-pink-400" />
